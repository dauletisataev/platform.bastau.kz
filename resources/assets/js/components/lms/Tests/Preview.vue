<template>
    <div class="card mb-5">
        <div class="card-header lead">
            <div class="pull-left">
                {{ name ? name : "Домашнее задание" }}
            </div>
            <div class="pull-right" style="margin-top:-2px">
                <div class="badge badge-default" style="font-weight: 500">
                    {{ tasks.length }} {{ $common.declOfNum(titles,tasks.length) }}
                </div>
            </div>
        </div>
        ...
        <div class="card-footer">
            <div class="pull-left">
                <b-button-group size="sm">
                    <b-button :id="'pagination_'+index" :class="{'active': index==slide}" @click="moveTo(index)" v-for="(task,index) in tasks" :key="task.id" >
                        {{ index+1 }}
                    </b-button>
                </b-button-group>
            </div>
