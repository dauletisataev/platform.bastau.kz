<template>
    <div class="sidebar container-fluid mt-4">
        <template v-if="$root.user.isAdmin()">
        <div class="row">
        ...
        <!-- Yersultan:Sidebar for participant--->
        <template v-if="$root.user.isParticipant()">
            <div class="row">
                <div class="col-2 bg-faded fixed-top h-100 pt-4 text-white bg-inverse small" style="z-index:3003">
                    <div class="clearfix">
                        <div class="pull-left mr-2">
                    ...
                    <ul>
                        <li class="mb-2">
                            <router-link to="/role-participant/lessons"
                                 :class="{'text-muted': participant_lessons.indexOf($route.name) < 0,'text-white': participant_lessons.indexOf($route.name) > -1 }" >
