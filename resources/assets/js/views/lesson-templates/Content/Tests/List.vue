                    ...
                    <td class="text-right">
                        <div class="btn-group">
                            <div class="btn-group">
                                ...
                                <a href="javascript:void(0)" @click="$emit('testEdit',test.id)" class="btn btn-sm btn-secondary" data-toggle="tooltip" data-title="изменить" data-original-title="" title="">
                                    <span class="fa fa-pencil"></span>
                                </a>
                                <a href="javascript:void(0)" @click="deleteTest(test.id)" class="btn btn-sm btn-outline-danger" data-toggle="tooltip" data-title="удалить тест" data-original-title="" title="">
