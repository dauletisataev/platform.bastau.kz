            ...
            <dropdown animation="ani-none" :position="['left', 'top', 'right', 'top']" :visible="visible" >
                ...
                <div slot="dropdown" class="dialog" style="z-index: 1000; min-width: 10rem;padding: .5rem 0;margin: .5rem 0 0;font-size: 1rem;color: #292b2c;text-align: left;list-style: none;background-color: #fff;-webkit-background-clip: padding-box;background-clip: padding-box;border: 1px solid rgba(0,0,0,.15);border-radius: .25rem;">
                    <div class="px-3 py-2" style="width: 302px;"  >
                        ...
                        <div class="form-group">
                            <div class="small font-weight-bold text-muted">время занятий</div>
                            <div class="clearfix datepair">
                                <div class="input-group input-group-sm"><span class="input-group-addon">с</span><timepicker v-model="filterData.timeFrom" active="1"></timepicker><span class="input-group-addon">до</span><timepicker v-model="filterData.timeTo" active="1"></timepicker></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="small font-weight-bold text-muted">время занятий</div>
                            <table class="table table-responsive table-sm small">
                                ...
                                <tr>
                                    <td v-for="day in 6">
                                        <label class="custom-control form-control-sm custom-checkbox mr-1"> <input type="checkbox" class="custom-control-input" :value="day" v-model="filterData.days"> <span class="custom-control-indicator"></span></label>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            setSelect()
            {
                if(this.filterData.office_ids && this.filterData.office_ids.length!=0)
            ...
            countFilters() {
                ...
                if(this.filterData.timeFrom) count++;
                if(this.filterData.days.length>0) count++;
                return count;
            },
